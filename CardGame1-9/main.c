...
//Players status & info
                    ...
                    Letter_Draw_Normal(fontDataWidth_Ext, fontData_Ext, fieldWidth, field, Card_DesignWidth * 5, font_size * (i + 5), print_field, font_size);
                    Mny_Bt_Draw(fontDataWidth_Ext, fontData_Ext, fieldWidth, field, -1, Poker.players[i].bet, -2, Poker.call, &Poker.players[i].Error, Card_DesignWidth * 5.5, font_size * (i + 5), font_size);
                    Mny_Bt_Draw(fontDataWidth_Ext, fontData_Ext, fieldWidth, field, -1, Poker.players[i].bet, -1, Poker.call, &Poker.players[i].Error, Card_DesignWidth * 2 * i, Card_Height + font_size*2 + 2, font_size);
                }
//Ai win prob cal
                for(int i = 0; i < PLAYER; i++)
...
//                   Mny_Bt_Draw(fontDataWidth_Ext, fontData_Ext, fieldWidth, field, -1, Poker.players[i].bet, -2, Poker.call, &Poker.players[i].Error, Card_DesignWidth * 5, font_size + font_size * 2 * (i + 1), font_size);
                Mny_Bt_Draw(fontDataWidth_Ext, fontData_Ext, fieldWidth, field, -1, Poker.players[i].bet, -1, Poker.call, &Poker.players[i].Error, Card_DesignWidth * 2 * i, Card_Height + font_size*2 + 2, font_size);
                Mny_Bt_Draw(fontDataWidth_Ext, fontData_Ext, fieldWidth, field, -1, Poker.players[i].bet, -2, Poker.call, &Poker.players[i].Error, Card_DesignWidth * 5.8, font_size * (i + 5), font_size);
                Letter_Draw_Normal(fontDataWidth_Ext, fontData_Ext, fieldWidth, field, Card_DesignWidth * 5, font_size * (i + 5), Hands_Rank_Ext[Poker.players[i].Hand_id.hand], font_size);
