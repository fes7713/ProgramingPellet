...
int main(int argc, char **argv)
{
    ...
    {
        //getchar();
        //int effPopInRad = infected * radius * (Population - nRecovered - nDeath - sumArray(arrIsolated, i)) / Population
//success (110 days 9800)
            //radius /= 1.002;
//Success keeping low
            //radius = radius / (1.001 * exp(1 / (i * 20000 + 1)));
//exploded and recovered (aid with radius /= 1.002)(113 days 18900)
//            radius /= 1.002;
...
//        }
        ...
        printf("Infected : %d (Ratio %.2lf) Recovery : %d Death : %ld Isolated : %d\n", infected, (double)infected / prevInfected, nRecovered, nDeath,  sumArray(arrIsolated, i));
