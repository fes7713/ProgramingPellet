...
int main(int argc, char **argv)
{
    ...
    for(int i = 0; i < DAY; i++)
    {
        ...
        int effPopInRad = Limit((int)(radius * infected), Population - nRecovered - infected - nDeath);
...
//Death
        ...
        printf("Infected : %d Recovery : %d Death : %d\n", infected, nRecovered, nDeath);
