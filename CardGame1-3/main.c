...
int Betting(int *bet, int *money, int min_bet, int *call, int *raise, int *pot);
...
void Pay_Bet(int *money, int bet, int *pot);
...
//Stage & pot
            ...
            if((self->Error = Betting(&self->bet, &self->coin, Poker.min_bet, &Poker.call, &Poker.raise, &Poker.pot)) == 6)
                break;
        }
