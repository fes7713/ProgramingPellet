...
char ProtectorNames[][18][NAME] = {{"0  Drachen a", "1  Dante a", "2  AzureSTarloard a", "3  Empress y", "4  Xeno y", "5  Zoara y", "6  Nergigante y", "7  Kaiser y", "8  GalaSuit a", "9  Empress b", 
...
{"0  Attack", "1  Critical Eyes", "2  Peak Performance", "3  Agitator", "4  Maximum Might", "5  Weakness Exploit", "6  Critical Boost", "NONE"}};

char ProtectorTypes[][NAME] = {"Helmet  :", "Chest   :", "Arm     :", "Waist   :", "Leg     :", "Charm   :"};
